    ...
    <section class="container flex flex-col  gap-6 py-8 md:max-w-[64rem] md:py-12 lg:py-24">
      <div class="mx-auto flex w-full flex-col gap-4 md:max-w-[58rem]">
        ...
        <main class="w-full flex flex-col px-2 my-6">
          <h2 class="font-semibold text-xl my-2">Terms &amp; Conditions</h2>
          <p class="my-1 leading-7">
            ...
            rights related to it, still belong to GetLicensed under their licenses provide.
          </p>
          <p class="my-1 leading-7">
            GetLicensed (&quot;GetLicensed.dev&quot;, &quot;we&quot;, &quot;us&quot;, and/or &quot;our&quot;) built the Release Note is committed to ensuring that the app is as useful and efficient as possible. For that reason, we
          ...
          <p class="my-1 leading-7">
            The GetLicensed app stores and processes personal data that you have provided to us, to provide my Service.
            ...
            programs, compromise your phone’s security features and it could mean that the GetLicensed app won’t work
            properly or at all.
          </p>
          <p class="my-1 leading-7">
            You should be aware that there are certain things that GetLicensed.dev will not take responsibility for. Certain
            functions of the app will require the app to have an active internet connection. The connection can be Wi-Fi or
            provided by your mobile network provider, but GetLicensed.dev cannot take responsibility for the app not working at full
          ...
          <p class="my-1 leading-7">
            Along the same lines, GetLicensed.dev cannot always take responsibility for the way you use the app i.e. You need to
            make sure that your device stays charged – if it runs out of battery and you can’t turn it on to avail the
            Service, GetLicensed.dev cannot accept responsibility.
          </p>
          <p class="my-1 leading-7">
            With respect to GetLicensed.dev responsibility for your use of the app, when you’re using the app, it’s important to
            bear in mind that although we endeavor to ensure that it is updated and correct at all times, we do rely on
            third parties to provide information to us so that we can make it available to you. GetLicensed.dev accepts no liability
          ...
          <p class="my-1 leading-7">
            ...
            need to download the updates if you want to keep using the app. GetLicensed.dev does not promise that it will always
          ...
          <h3 class="font-semibold text-lg my-2">Changes to This Terms and Conditions</h3>
          <p class="my-1 leading-7">
            GetLicensed may update our Terms and Conditions from time to time. Thus, you are advised to review this page
