    ...
    <section class="container flex flex-col  gap-6 py-8 md:max-w-[64rem] md:py-12 lg:py-24">
      <div class="mx-auto flex w-full flex-col gap-4 md:max-w-[58rem]">
        <main class="w-full flex flex-col px-2 my-6">
          <h1 class="font-semibold text-xl my-2">Privacy Policy</h1>
          <p class="my-1 leading-7">
            GetLicensed (&quot;GetLicensed.dev&quot;, &quot;we&quot;, &quot;us&quot;, and/or &quot;our&quot;) This SERVICE is provided at no cost and is intended for use as is.
          </p>
          <p class="my-1 leading-7">
          ...
          <p class="my-1 leading-7">
            ...
            accessible at GetLicensed unless otherwise defined in this Privacy Policy.
          </p>
          <h3 class="font-semibold text-lg my-2">Information Collection and Use</h3>
          <p class="my-1 leading-7">
            For a better experience, while using our Service, I may require you to provide us with certain personally
            identifiable information, including but not limited to Email Id, Profile Photo and Full name via Google OAuth
            Login by you. The app does use third-party services that may collect information used to identify you.
          </p>
          <h3 class="font-semibold text-lg my-2">Log Data</h3>
          <p class="my-1 leading-7">
          ...
          <h3 class="font-semibold text-lg my-2">Cookies</h3>
          <p class="my-1 leading-7">
          ...
          <h3 class="font-semibold text-lg my-2">Service Providers</h3>
          <p class="my-1 leading-7">I may employ third-party companies and individuals due to the following reasons:</p>
          <ul class="px-6 my-1 list-decimal leading-7">
          ...
          <h3 class="font-semibold text-lg my-2">Security</h3>
          <p class="my-1 leading-7">
          ...
          <h3 class="font-semibold text-lg my-2">Links to Other Sites</h3>
          <p class="my-1 leading-7">
          ...
          <h3 class="font-semibold text-lg my-2">Children’s Privacy</h3>
          <div>
            <p class="my-1 leading-7">
              ...
              instructing their children never to provide personally identifiable information through the Application and/or
              Services without their permission. If you have reason to believe that a child has provided personally
              identifiable information to us through the Application and/or Services, please contact us. You must also be at
              least 16 years of age to consent to the processing of your personally identifiable information in your country
              (in some countries we may allow your parent or guardian to do so on your behalf).
            </p>
          </div>
          <h3 class="font-semibold text-lg my-2">Changes to This Privacy Policy</h3>
          <p class="my-1 leading-7">
          ...
          <p class="my-1 leading-7">
            This policy is effective as of <span class="font-medium">2024-04-01</span>.
          </p>
          <h3 class="font-semibold text-lg my-2">Contact Us</h3>
          <p class="my-1 leading-7">
            If you have any questions or suggestions about my Privacy Policy, do not hesitate to contact me at
            <a class="cursor-pointer text-blue-700 underline" href="mailto:hello@GetLicensed.dev">
              hello@GetLicensed.dev
            </a>
            .
          </p>
        </main>
